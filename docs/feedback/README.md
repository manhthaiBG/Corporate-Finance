...
This directory holds instructor PR review files and student response memos for the BUS-629 Corporate Finance project.
...
Instructor review files are delivered as pull requests and merged into `main` to preserve a permanent record. Response memos are committed directly to `main` on the same day the changes are incorporated.
